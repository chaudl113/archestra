...
export const TOOL_SORTING_HAT_SORT_SHORT_NAME = "sorting_hat_sort";
export const TOOL_SORTING_HAT_PATRONUS_SHORT_NAME = "sorting_hat_patronus";
export const TOOL_SORTING_HAT_FLOO_SHORT_NAME = "sorting_hat_floo";
export const TOOL_SORTING_HAT_QUIDDITCH_SHORT_NAME = "sorting_hat_quidditch";
...
// Sorting Hat MCP full names
export const TOOL_SORTING_HAT_SORT_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_SORTING_HAT_SORT_SHORT_NAME}` as const;
export const TOOL_SORTING_HAT_PATRONUS_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_SORTING_HAT_PATRONUS_SHORT_NAME}` as const;
export const TOOL_SORTING_HAT_FLOO_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_SORTING_HAT_FLOO_SHORT_NAME}` as const;
export const TOOL_SORTING_HAT_QUIDDITCH_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_SORTING_HAT_QUIDDITCH_SHORT_NAME}` as const;
